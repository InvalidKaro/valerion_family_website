...
const ChangeProfile = () => {
  ...
  const handleProfilePictureUpload = async (e) => {
    ...
    if (!allowedFileTypes.includes(file.type)) {
      setMessage(
        "Invalid file type. Please select a GIF, PNG, JPG or JPEG image."
      );
      return;
    }
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          loginUser({
            ...user,
            profileData: {
              profileInfo: { filetype: data.fileType, filename: data.filename },
            },
          });
        }
        console.log(user);
    ...
    <div className="acc-set">
      ...
      {user.profileData && (
        <div className="current-profile-picture">
          ...
          {["gif", "jpg", "jpeg", "png"].includes(
            user.profileData.profileInfo.filetype
          ) ? (
